...
open class TestBase {
    ...
    companion object {
        ...
        val ALL_MODES = intArrayOf(MODE_INPUT_STREAM, MODE_INPUT_STREAM_THROTTLED, MODE_READER, MODE_READER_THROTTLED,
                MODE_DATA_INPUT)

        val ALL_BINARY_MODES = intArrayOf(MODE_INPUT_STREAM, MODE_INPUT_STREAM_THROTTLED, MODE_DATA_INPUT)

        val ALL_TEXT_MODES = intArrayOf(MODE_READER, MODE_READER_THROTTLED)

        val ALL_STREAMING_MODES =
