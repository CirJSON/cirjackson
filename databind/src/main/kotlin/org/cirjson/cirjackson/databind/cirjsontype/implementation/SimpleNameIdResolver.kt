 ...
 * defaults to simple [KClass] names (obtained with [KClass.qualifiedName]. Basically same as [TypeNameIdResolver]
 * except for default to "simple" and not "full" class name.
 *
 ...
 */
open class SimpleNameIdResolver protected constructor(baseType: KotlinType,
    ...
    companion object {
        ...
        fun construct(config: MapperConfig<*>, baseType: KotlinType, subtypes: Collection<NamedType>?,
                forSerialization: Boolean, forDeserialization: Boolean): SimpleNameIdResolver {
            ...
            subtypes ?: return SimpleNameIdResolver(baseType, typeToId, idToType, caseInsensitive)
            ...
            return SimpleNameIdResolver(baseType, typeToId, idToType, caseInsensitive)
        }
