 ...
 */
class InvalidFormatException(parser: CirJsonParser?, message: String, val value: Any?, targetType: Class<*>) :
        MismatchedInputException(parser, message, targetType) {

    companion object {

        fun from(parser: CirJsonParser?, message: String, value: Any?, targetType: Class<*>): InvalidFormatException {
