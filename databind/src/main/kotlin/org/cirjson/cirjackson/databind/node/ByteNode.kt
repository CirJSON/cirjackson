...
/**
 * Numeric node that contains simple 8-bit integer values.
 */
open class ByteNode constructor(protected val myValue: Byte) : NumericNode() {
    ...
    companion object {
        ...
        fun valueOf(value: Byte): ByteNode {
